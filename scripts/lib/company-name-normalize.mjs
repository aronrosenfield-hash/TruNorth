 ...
 *   - parseCSV(text) -> string[][]          (rfc-4180-ish row arrays)
 *   - parseCSVToObjects(text) -> object[]   (header-keyed objects)
 */
...
/**
 * Tiny RFC-4180-ish CSV parser. Handles double-quoted cells, embedded
 * commas, embedded newlines (LF or CRLF), and "" escapes inside quotes.
 *
 * Returns rows as arrays of strings. An empty trailing row is dropped.
 * Used by the DW-1…DW-6 fetchers that read fixture CSVs without pulling
