...
## ▶ NEXT BUILD (Build 79, iOS) — pre-ship worklist (updated 2026-07-03)

> ⚠️ **The iOS binary already advanced to v1.1 / Build 78** (Builds 76–78 shipped to TestFlight; next = 79). NB-1 below (the 75→76 bump) is therefore **DONE/moot**. The 2026-07-02 diligence fixes are on `main` awaiting Aron's device test + a Build 79 submission. Everything else below was reconciled 2026-06-27 — re-verify before acting.

| # | Item | What / why (verified) | Status |
|---|---|---|---|
| **NB-1** | ~~Bump iOS build 75 → 76~~ | **✅ DONE + PAST** — binary is now v1.1 / Build **78** on main (`CURRENT_PROJECT_VERSION = 78`, lines 300 & 324; `ship:ios` auto-bumps). Next ship = **79**. | ✅ moot |
...
4. ~~**NB-1 iOS bump**~~ — ✅ moot; binary is already v1.1 / Build **78** on main (next ship = 79). The pending gate is Aron device-testing the 2026-07-02 diligence fixes (esp. **C5 server-side entitlement** — needs a Sandbox purchase/cancel) before a Build 79 App Review submission.
