...
const COMPANIES = [
  { emoji:"🛍️", bg:"#1a2e1a", name:"Costco",    meta:"Retail · Warehouse",     grade:"A", gradeStyle:{background:"#10231F",color:"#3DD6B5"}, details:[{label:"🌿 Environment",pct:80,color:"#3DD6B5",grade:"B+"},{label:"🏳️ DEI",pct:82,color:"#3DD6B5",grade:"A-"},{label:"❤️ Charity",pct:78,color:"#3DD6B5",grade:"B+"}] },
  { emoji:"🚗", bg:"#1a1a2e", name:"Tesla",     meta:"Automotive · EVs",       grade:"B", gradeStyle:{background:"#19230F",color:"#9CC98A"}, details:[{label:"🌿 Environment",pct:78,color:"#3DD6B5",grade:"B+"},{label:"🏳️ DEI",pct:65,color:"#9CC98A",grade:"B"},{label:"⚖️ Labor",pct:35,color:"#E0524D",grade:"D"}] },
...
const CATEGORIES = [
  ...
  { emoji:"🌿", bg:"#1E4A3F", name:"Environment",         desc:"EPA violations, pollution penalties",  pct:80 },
  ...
  { emoji:"💵", bg:"#1E4A3F", name:"Executive Pay",       desc:"CEO-to-worker pay ratio",              pct:40 },
];
    ...
    <div style={s.wrap}>
      <div style={s.slideWrap}>
        <div style={s.slide}>
          ...
          <h1 style={s.headline}>Your wallet<br />is a <em style={{ color:"#3DD6B5", fontStyle:"normal" }}>vote.</em><br />Cast it wisely.</h1>
          ...
          <p style={{ ...s.terms, marginTop:14 }}>By continuing you agree to our <a href="https://www.apple.com/legal/internet-services/itunes/dev/stdeula/" target="_blank" rel="noopener noreferrer" style={{ color:"#3DD6B5", textDecoration:"none" }}>Terms</a> & <a href="https://www.trunorthapp.com/#privacy" target="_blank" rel="noopener noreferrer" style={{ color:"#3DD6B5", textDecoration:"none" }}>Privacy Policy</a>.</p>
        </div>
      </div>
...
const s = {
  ...
  eyebrow:         { fontSize:11, fontWeight:600, letterSpacing:2, textTransform:"uppercase", color:"#3DD6B5", marginBottom:16 },
  ...
  demoCard:        { marginTop:28, background:"#16181D", borderRadius:20, padding:18, border:"1px solid #23262C", borderTop:"2px solid #3DD6B5" },
  ...
  tapDot:          { width:6, height:6, borderRadius:"50%", background:"#3DD6B5" },
  ...
  catFill:         { height:"100%", borderRadius:3, background:"linear-gradient(90deg,#3DD6B5,#5FE3C8)" },
  ...
  ctaArtInner:     { width:70, height:70, background:"#3DD6B5", borderRadius:20, display:"flex", alignItems:"center", justifyContent:"center" },
  statsRow:        { display:"flex", justifyContent:"space-around", marginBottom:24 },
  statNum:         { fontSize:22, fontWeight:800, color:"#3DD6B5", textAlign:"center" },
  ...
  authTabActive:   { background:"#3DD6B5", color:"#fff" },
  ...
  dotActive:       { width:20, background:"#3DD6B5" },
  btnPrimary:      { width:"100%", padding:16, background:"#3DD6B5", border:"none", borderRadius:14, color:"#fff", fontFamily:"inherit", fontSize:15, fontWeight:700, cursor:"pointer", marginBottom:10 },
