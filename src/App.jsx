...
export default function App() {
  const [screen, setScreen]     = useState(()=>localStorage.getItem("tn_screen")||"quiz");
  const [profile, setProfile]   = useState(()=>{ try { return JSON.parse(localStorage.getItem("tn_profile")); } catch { return null; } });
  const [isPaid, setIsPaid]     = useState(()=>localStorage.getItem("tn_paid")==="true");
  ...
  const [tab, setTab]           = useState(()=>localStorage.getItem("tn_tab")||"top");
