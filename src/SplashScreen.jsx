...
export default function SplashScreen({ onDone }) {
  ...
  return (
    <div style={styles.wrap}>
      ...
      `}</style>
      <div className="tn-splash-wrap" style={styles.wrap}>
...
const styles = {
  wrap: { position:"fixed", inset:0, background:"#0f0f0f", display:"flex", alignItems:"center", justifyContent:"center", zIndex:9999 },
