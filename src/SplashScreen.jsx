          ...
          <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:14 }}>
            <div className="tn-splash-logo" style={styles.logo}>
              ...
              <div style={styles.wordmark}>
                ...
                <span style={{ color: "#38C0CE" }}>North</span>
              </div>
            </div>
...
const styles = {
  ...
  icon:  { width:52, height:52, background:"#38C0CE", borderRadius:14, display:"flex", alignItems:"center", justifyContent:"center", fontSize:26, color:"#fff" },
